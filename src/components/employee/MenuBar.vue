<template>
  <div id="menu">
    <div class="bar">
      <router-link to="/training" class="txt-bar">
        <font-awesome-icon icon="biking" class="menu-icon"></font-awesome-icon>
        <span>Training</span>
      </router-link>
    </div>
    ...
    <div class="bar">
      <router-link to="/notification" class="txt-bar" style="position: relative">
